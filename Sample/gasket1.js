...
window.onload = function init()
{
    ...
    for ( var i = 0; positions.length < numPositions; ++i ) {
        ...
        // this.console.log("Position0: "+ positions[i][0]);
        // this.console.log("Position1: "+ positions[i][1]);
        // this.console.log("P0: "+p[0]);
        // this.console.log("P1: "+p[1]);

        p = mult(0.5, p);
        p[0]=p[0]*this.randomVariation();
        p[1]=p[1]*this.randomVariation();
